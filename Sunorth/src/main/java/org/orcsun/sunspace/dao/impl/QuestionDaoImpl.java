...
/*  48 */     String sql = null;
/*  49 */     Object[] args = null;
/*  50 */     sql = "update question_" + lang + " set question=?,tag=?,description=? where qid=?";
/*  51 */     args = new Object[] { q.getQuestion(),  q.getTag(),  q.getDescription(), Long.valueOf(q.getQid()) };
...
/* 113 */     return getJdbcTemplate().query(sql, new QuestionMapper(this.userDao));
    ...
    {
/* 118 */     String sql = "select qid,pid,cid,question,tag,rate,answercnt,uid,description,qtime,status from question_" + lang + " order by qtime desc limit "+start +","+ end;
/* 119 */     logger.info(sql);
