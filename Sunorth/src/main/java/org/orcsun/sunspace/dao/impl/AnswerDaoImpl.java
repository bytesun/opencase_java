...
/* 32 */     String sql = null;
/* 33 */     Object[] args = null;
/* 34 */     sql = "insert into answer_" + lang + "(qid,answer,atime,rate,uid) values(?,?,?,?,?)";
/* 35 */     args = new Object[] { Long.valueOf(a.getQid()), a.getAnswer(), Long.valueOf(System.currentTimeMillis()), Integer.valueOf(0), Long.valueOf(a.getUser().getUid()) };
/* 36 */     logger.info("Add a new answer :" + sql);
/* 37 */     return getJdbcTemplate().update(sql, args);
/*    */   }
/*    */ 
/*    */   public int delAnswer(long qid, long uid, long atime, String lang)
/*    */   {
/* 42 */     String sql = "delete from answer_" + lang + " where qid=? and uid=? and atime=?";
/* 43 */     logger.info(sql);
/* 44 */     Object[] args = { Long.valueOf(qid), Long.valueOf(uid), Long.valueOf(atime) };
/*    */ 
...
/*    */   {
/* 51 */     String sql = "select aid,qid,answer,atime,rate,uid from answer_" + lang + " where qid=" + qid;
/* 52 */     logger.info(sql);
/*    */ 
...
/*    */   }
/*    */ 
/*    */   public int voteAnswer(long aid, int vote, String vcomment, long uid, String lang) {
/* 66 */     String sql = "update answer_" + lang + " set rate=(rate+" + vote + ") where aid=" + aid;
/* 67 */     logger.info(sql);
...
/* 86 */       a.setAtime(rs.getLong("atime"));
 ...
 * Qualified Name:     org.orcsun.sunspace.dao.impl.AnswerDaoImpl
